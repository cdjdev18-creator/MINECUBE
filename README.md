...
Este proyecto es un motor de juego en 3D desarrollado en **Java**, diseñado para renderizar bloques, entidades y mapas usando texturas en formato atlas y modelos personalizados.

En esta **versión 1.3**, se han integrado avances clave en el renderizado de mapas de textura (`terrain.png`), la fragmentación de sprites individuales y la implementación de entidades 3D personalizadas (como modelos de cerdos y bloques funcionales).
...
* 🗂️ **Carga Individual de Sprites:** Compatibilidad con texturas $16 \times 16$ desglosadas por casillas/tiles.
* 🛠️ **Optimización de Renderizado:** Ajustes en los puntos de pivote para animaciones de extremidades y rotaciones.
